...
def train(X_train, y_train):
    ...
    return model
    # test(grid, _REMS_project_path, _training_data_path, _output_write_path)
...
def runAllTests():
    ...
    output_file = "C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\outputs\\DT_test.txt"
    count = 0
    testTrainDict = {}
    ...
    for key in testTrainDict:
        ...
        outs.append(['DT', emb1, emb2, p, r, f1])
...
def write_to_csv(outs):
    output_csv = "C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\outputs\\DT_results.csv"

...
def train(X_train, y_train):
    ...
    return model
    # test(model, _REMS_project_path, _training_data_path, _output_write_path)
...
def runAllTests():
    ...
    for key in testTrainDict:
        ...
        outs.append(['NB', emb1, emb2, p, r, f1])
...
def write_to_csv(outs):
    output_csv = "C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\outputs\\NB_results.csv"
...
if __name__ == '__main__':
    # KNN-CodeBERT-grarep (5)
    # DT-CodeGPT-grarep (5)
    # NB-GraphCodeBERT-node2vec (5)
    training_csv = "C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\Training_CSV\\"
    test_data = "C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\GEMS_test_data"
    output_file = "C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\outputs\\KNN_test.txt"
    start_time = time.time()
    test_methods = [
        'C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\GEMS_test_data\\JHotDraw\\GraphCodeBERT\\node2vec_cg.csv',
        'C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\GEMS_test_data\\JUnit\\GraphCodeBERT\\node2vec_cg.csv',
        'C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\GEMS_test_data\\MyWebMarket\\GraphCodeBERT\\node2vec_cg.csv',
        'C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\GEMS_test_data\\SelfPlanner\\GraphCodeBERT\\node2vec_cg.csv',
        'C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\GEMS_test_data\\WikiDev\\GraphCodeBERT\\node2vec_cg.csv',
    ]
    # runAllTests()
    X_train, y_train = load_data(_training_data_path)
    model = train(X_train, y_train)
    for test_method in test_methods:
        emb1, emb2, p, r, f1 = test(model, test_method, output_file)
        method = _REMS_project_path.split('\\')[-3]
        print(method+'\t'+str(emb1)+'\t'+str(emb2)+'\t'+str(p)+'\t'+str(r)+'\t'+str(f1))

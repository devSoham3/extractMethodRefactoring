# -*- encoding = utf-8 -*-
"""
@description: 用XGB训练并对REMS数据进行测试
@date: 2022/9/28
@File : XGB.py
@Software : PyCharm
"""
...
def train(X_train, y_train):
    ...
    tuned_parameters = {
            ...
            'learning_rate': np.linspace(0.1, 2, 5),
    ...
    grid = GridSearchCV(XGBClassifier(eval_metric=['logloss', 'auc', 'error']), tuned_parameters, cv=5,
...
def runAllTests():
    ...
    for key in testTrainDict:
        ...
        outs.append(['XGB', emb1, emb2, p, r, f1])
...
def write_to_csv(outs):
    output_csv = "C:\\Users\\devso\\OneDrive\\Desktop\\Coding\\DSCI-644\\Project\\project-dsci-644-group-9-group-9\\rems_modified\\outputs\\XGB_results.csv"
